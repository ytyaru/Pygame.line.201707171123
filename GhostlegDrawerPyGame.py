...
#        print(pygame.font.get_fonts()) # 使えるフォント名
    ...
    def Select(self, select_line_index):
        ...
        self.__linesanim = LinesAnimation(self.__to_goal_pointlist, self.__screen.Size[0], self.__screen.Size[1])
...
#        self.__to_goal_pointlist.append([20 + now_line_index * 40, 20 + 1 * 24])
...
#                    self.__set_pointlist_value(now_line_index+1, y+1)
                    self.__set_pointlist_value(now_line_index, y+1)
                    self.__to_goal_pointlist.append([20 + (now_line_index+1) * 40, 20 + ((y+1) * 24)])
...
#                    self.__set_pointlist_value(now_line_index-1, y+1)
                    self.__set_pointlist_value(now_line_index, y+1)
                    self.__to_goal_pointlist.append([20 + (now_line_index-1) * 40, 20 + ((y+1) * 24)])
#                    self.__to_goal_pointlist.append([20 + (now_line_index-2) * 40, 20 + ((y+1) * 24)])
#                    self.__to_goal_pointlist.append([20 + (now_line_index-1) * 40, 20 + ((y+2) * 24)])
                    now_line_index += -1
                else: # ｜
                    self.__set_pointlist_value(now_line_index, y+1)
